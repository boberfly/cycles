...
if(CMAKE_COMPILER_IS_GNUCXX)
  ...
  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Wall -Wno-sign-compare -Wno-invalid-offsetof -fno-strict-aliasing -std=c++20 -fPIC")
...
if(APPLE)
  if(NOT ${CMAKE_GENERATOR} MATCHES "Xcode")
    ...
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET} -std=c+20 -stdlib=libc++")
...
elseif(MSVC)
  set(CMAKE_CXX_FLAGS "/nologo /J /Gd /EHsc /bigobj /MP /std:c++20 /utf-8" CACHE STRING "MSVC MD C++ flags " FORCE)
