...
if(WITH_USD)
  ...
  if(NOT HOUDINI_ROOT AND NOT PXR_ROOT AND WIN32)
...
if(WITH_CYCLES_OSL)
  set(CMAKE_REQUIRE_FIND_PACKAGE_OSL TRUE)
  if(PXR_ROOT)
    # Vanilla USD builds don't have OSL
    set(CMAKE_REQUIRE_FIND_PACKAGE_OSL FALSE)
  endif()
	if(MSVC AND EXISTS ${_cycles_lib_dir})
		set(OSL_ROOT ${OSL_ROOT_DIR})
		find_package(OSL CONFIG)
...
if(WITH_CYCLES_NANOVDB)
  set(CMAKE_REQUIRE_FIND_PACKAGE_NanoVDB TRUE)
  if(PXR_ROOT)
    # Vanilla USD builds don't have NanoVDB
    set(CMAKE_REQUIRE_FIND_PACKAGE_NanoVDB FALSE)
  endif()

  if(MSVC AND EXISTS ${_cycles_lib_dir})
    set(NANOVDB_INCLUDE_DIR ${NANOVDB_ROOT_DIR}/include)
    set(NANOVDB_INCLUDE_DIRS ${NANOVDB_INCLUDE_DIR})
    set(NANOVDB_FOUND ON)
  else()
